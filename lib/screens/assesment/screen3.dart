...
import 'package:duo_clone/screens/assesment/screen4.dart';
    ...
    try {
      ...
      setState(() {
        pairs = snapshot.docs.map((doc) {
          ...
          // Gunakan null-aware operator untuk menangani nilai null
          return {
                    ...
                    Expanded(
                      child: ListView(
                        children: [
                          ...
                          ...pairs
                              .map((pair) => buildAudioButton(pair['name']!)),
                          const Divider(
                            color: Colors.white,
                            thickness: 1,
                          ),
                          ...
                          ...shuffledPairs.map(
                              (pair) => buildMatchingButton(pair['name']!)),
                          if (showResult)
                            Padding(
                              padding:
